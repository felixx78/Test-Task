...
function Sidebar() {
  ...
  return (
    <aside className="flex w-full flex-shrink-0 items-center justify-between bg-primary px-4 py-2 text-background sm:fixed sm:h-screen sm:w-[200px] sm:flex-col sm:items-stretch sm:px-0 sm:pt-4">
